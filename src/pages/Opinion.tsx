      ...
      <div className="relative z-10">
        <header className="px-4 py-4">
          <div className="max-w-md mx-auto flex items-center gap-2">
            ...
            <h1 className="font-display text-xl font-bold text-foreground drop-shadow-sm">Sua Opinião</h1>
          </div>
        </header>
        ...
        <div className="max-w-md mx-auto px-4 py-4 space-y-4">
          ...
          {submitted ? (
            <div className="bg-card/90 backdrop-blur-sm rounded-xl border border-primary/20 p-6 shadow-card text-center animate-fade-in">
            ...
            <div className="bg-card/90 backdrop-blur-sm rounded-xl border border-border/50 p-4 shadow-card space-y-4">
              <div>
