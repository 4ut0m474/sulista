    ...
    <div className="min-h-screen bg-background pb-20">
      <header className="bg-gradient-primary text-primary-foreground px-4 py-4">
        <div className="max-w-md mx-auto flex items-center gap-2">
          ...
          <h1 className="font-display text-xl font-bold">Planos</h1>
        </div>
      </header>
      ...
      <div className="max-w-md mx-auto px-4 py-4">
            ...
            return (
              <div
                ...
                className={`rounded-2xl border p-5 shadow-card transition-all ${
                  isVip
                    ? "border-gold bg-gradient-to-br from-card to-card ring-2 ring-gold shadow-gold"
                    : plan.highlight
              ...
              >
                ...
                <a
                  href="https://wa.me/5541992355421?text=Olá! Quero adquirir o plano ${plan.name} do Sulista."
                  target="_blank"
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Dúvidas? WhatsApp: (41) 99235-5421
        </p>
      </div>
