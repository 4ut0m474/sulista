      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <div className="flex flex-col items-center justify-center px-6 pt-16 pb-4">
          ...
          <div className="mt-5 flex items-end justify-center gap-4">
            ...
            >
              <div className="w-16 h-16 rounded-full flex items-center justify-center border-2 border-white/20 bg-transparent overflow-hidden transition-transform group-hover:scale-105 group-active:scale-95">
            ...
            {/* Litorânea — center (bigger) with strong pulse */}
            <button
              onClick={() => handleAgentClick("litoranea")}
              className="flex flex-col items-center gap-1.5 group relative"
            >
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-24 h-24 rounded-full" style={{ animation: 'multicolor-ping 2s cubic-bezier(0,0,0.2,1) infinite' }} />
              </div>
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-22 h-22 rounded-full" style={{ animation: 'multicolor-glow 2.5s ease-in-out infinite' }} />
              </div>
              <div className="w-20 h-20 rounded-full flex items-center justify-center border-4 bg-transparent overflow-hidden transition-transform group-hover:scale-105 group-active:scale-95 relative z-10" style={{ animation: 'multicolor-glow 2.5s ease-in-out infinite' }}>
